...
description: "Bir lineer dönüşümün çekirdeği ile görüntüsünün boyutlarını tanım kümesinin boyutuna bağlayan boyut teoremi, rank ve sıfırlık kavramları ile çözümlü hesap örnekleri."
---
...
::: {#def-rank-sifirlik name="Bir Dönüşümün Rankı ve Sıfırlığı"}
$V$ ve $U$, $K$ üzerinde iki vektör uzayı ve $F : V \to U$ bir lineer dönüşüm olsun. $F$'nin **rankı**
...
Sıfırlık, dönüşümün ezdiği yönlerin sayısıdır; rank ise ayakta kalan yönlerin sayısı. Toplamları sabittir: tanım kümesinin boyutu. Bu yüzden bir dönüşüm ne kadar çok ezerse görüntüsü o kadar dar olur — ikisini aynı anda büyütmek mümkün değildir.
:::
...
2. $T : \mathbb{R}^{4} \to \mathbb{R}^{4}$, $T(a_1,a_2,a_3,a_4) = (a_1,\ a_1+a_2,\ a_1+a_2+a_3,\ a_1+a_2+a_3+a_4)$ dönüşümünün rankını bulunuz.
3. Bir $T : \mathbb{R}^{5} \to \mathbb{R}^{3}$ lineer dönüşümünün sıfırlığı en az kaç olabilir?
...
Demek ki sıfırlık en az $2$'dir; özel olarak böyle bir dönüşümün çekirdeği hiçbir zaman yalnız sıfırdan ibaret olamaz.
