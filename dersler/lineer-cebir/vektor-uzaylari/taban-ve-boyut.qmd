...
::: {#def-taban name="Taban"}
$V$, $K$ komutatif cismi üzerinde bir vektör uzayı olsun. $V$'yi doğuran, yani
...
::: {#def-boyut name="Boyut"}
$n$ elemanlı bir tabanı bulunan $V$ vektör uzayına $n$**-boyutlu** (sonlu boyutlu) vektör uzayı denir ve $\dim V = n$ yazılır.
:::
