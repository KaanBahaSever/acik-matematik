...
olacak şekilde bir $T^{-1} \in A(V)$ varsa, $T^{-1}$ lineer operatörüne $T$'nin **tersi** denir. Tersi olan bir $T \in A(V)$ operatörüne **tersinir** (tersi olan) denir.
:::
...
::: {.ispat}
**Gereklik.** $T$ tersinir olsun. Bir fonksiyonun tersinin olması için gerek ve yeter koşul bire bir ve örten olmasıdır; özel olarak $T$ bire birdir. [Singüler olmama ölçütü](../lineer-tasvirler/singuler-tasvirler.qmd) gereği $\operatorname{Ker} T = \{0_V\}$, yani $T$ singüler değildir.

**Yeterlik.** $T$ singüler olmasın. O hâlde $\operatorname{Ker} T = \{0_V\}$'dir ve $T$ bire birdir. $V$ sonlu boyutlu olduğundan [boyut teoremi](../lineer-tasvirler/boyut-teoremi.qmd) uygulanabilir:
...
yani $T$ örtendir. $T$ hem bire bir hem örten olduğundan tersi vardır; ters fonksiyonun da lineer olduğunu [daha önce](../lineer-tasvirler/lineer-tasvirler.qmd) görmüştük, yani $T^{-1} \in A(V)$'dir.
