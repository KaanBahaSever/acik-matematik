...
$$
\begin{aligned}
\big(G \circ (F + F')\big)(v) &= G\big((F+F')(v)\big)\\[1mm]
&= G\big(F(v) + F'(v)\big)\\[1mm]
&= G\big(F(v)\big) + G\big(F'(v)\big)\\[1mm]
&= (G \circ F)(v) + (G \circ F')(v)\\[1mm]
...
$$
\begin{aligned}
\big((G + G') \circ F\big)(v) &= (G + G')\big(F(v)\big)\\[1mm]
&= G\big(F(v)\big) + G'\big(F(v)\big)\\[1mm]
&= (G \circ F)(v) + (G' \circ F)(v)\\[1mm]
&= \big(G \circ F + G' \circ F\big)(v)
\end{aligned}
...
$$\begin{aligned}
\big(k(G \circ F)\big)(v) &= k\,(G \circ F)(v) = k\,G\big(F(v)\big)\\[1mm]
&= (kG)\big(F(v)\big) = \big((kG) \circ F\big)(v)
\end{aligned}$$

Sonra ikincisi; burada $G$'nin lineerliği kullanılır:

$$\begin{aligned}
\big(k(G \circ F)\big)(v) &= k\,G\big(F(v)\big) = G\big(k F(v)\big)\\[1mm]
&= G\big((kF)(v)\big) = \big(G \circ (kF)\big)(v)
\end{aligned}$$
...
::: {#def-asosyatif-cebir name="Asosyatif Cebir"}
$K$ üzerinde bir $\mathcal{A}$ cebri, ayrıca her $F, G, H \in \mathcal{A}$ için
...
::: {#def-operator-polinomu name="Operatör Polinomu"}
...
::: {#def-operator-koku name="Polinomun Kökü"}
$T$, $V$ üzerinde bir lineer operatör ve $p(x)$, $K$ üzerinde bir polinom olsun. Eğer $p(T) = 0$ ise $T$'ye $p(x)$ polinomunun bir **kökü** (sıfırı) denir; buradaki $0$, $V$ üzerindeki sıfır operatörüdür.
:::
...
$$\begin{aligned}
(T + I)(a,b,c) &= T(a,b,c) + I(a,b,c)\\[1mm]
&= (0,a,b) + (a,b,c) = (a,\ a+b,\ b+c)
\end{aligned}$$
