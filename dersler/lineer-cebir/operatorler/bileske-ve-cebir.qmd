...
description: "İki lineer dönüşümün bileşkesinin lineerliği, bileşkenin toplama ve skalerle çarpımla uyumu, lineer operatörler cebri A(V), operatör kuvvetleri ve operatör polinomları."
---
...
$V$, $U$ ve $W$, aynı bir $K$ komutatif cismi üzerinde üç vektör uzayı; $F : V \to U$ ve $G : U \to W$ iki lineer dönüşüm olsun. Bu durumda bileşke fonksiyon
...
$V$, $U$, $W$ üç vektör uzayı; $F, F' : V \to U$ ve $G, G' : U \to W$ lineer dönüşümler ve $k \in K$ olsun. Bu durumda
...
[Dönüşümlerin uzayı](hom-uzayi.qmd) bölümündeki iki teoremden hemen şunlar çıkar: $A(V)$, $K$ üzerinde bir vektör uzayıdır ve $V$ $n$ boyutlu ise
...
1. $F : \mathbb{R}^{3} \to \mathbb{R}^{2}$, $F(x,y,z) = (2x,\ y+z)$ ve $G : \mathbb{R}^{2} \to \mathbb{R}^{2}$, $G(x,y) = (y,x)$ olsun. $G \circ F$ dönüşümünü bulunuz; $F \circ G$ tanımlı mıdır?
