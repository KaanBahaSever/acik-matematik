...
*Doğrulama.* $\left(\frac{1}{3}\arcsin\frac{3x}{2}\right)' = \frac{1}{3}\cdot\frac{1}{\sqrt{1-\frac{9x^2}{4}}}\cdot\frac{3}{2} = \frac{1}{2}\cdot\frac{2}{\sqrt{4-9x^2}} = \frac{1}{\sqrt{4-9x^2}}$. Doğru.
