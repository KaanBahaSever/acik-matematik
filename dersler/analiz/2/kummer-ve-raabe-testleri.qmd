...
$\dfrac{1}{k} \to 0$ olduğundan (@cor-arsimet-bir-bolu-n) ve karekök fonksiyonu sürekli olduğundan, limit aritmetiği (@thm-limit-aritmetigi) gereği
...
::: {.ispat}
@thm-raabe-testi'nin ispatındaki (4) bağıntısına göre $K_k = R_k - 1$'dir; burada $K_k$, $c_k = k$ seçimine karşılık gelen Kummer niceliğidir. Limit aritmetiği (@thm-limit-aritmetigi) gereği $R$ sonluysa
...
yazılır. $k < \xi < k+1$ olduğundan $\dfrac{k+1}{k+1} < \dfrac{k+1}{\xi} < \dfrac{k+1}{k}$, yani $1 < \lambda_k < 1 + \dfrac{1}{k}$ olur. Sıkıştırma teoremi (@thm-sikistirma-dizi) gereği ayrıca
...
$r - 1 > 0$ olduğundan Arşimet özelliği gereği (@cor-arsimet-bir-bolu-n) öyle bir $N_1 \in \mathbb{N}$ vardır ki her $k \ge N_1$ için $\dfrac{1}{k} < \dfrac{r-1}{2}$ olur. $N_2 = \max\{N, N_1\}$ alalım; her $k \ge N_2$ için
...
**Adım 5: Limit biçimi.** $B_k \to B$ olsun. $\lambda_k \to 1$ olduğundan (5) ve limit aritmetiği (@thm-limit-aritmetigi) gereği, $B$ sonluysa
...
- $t_k \to 0$'dır: pay $\ln\left( 1 + \frac{1}{k} \right) \to 0$, payda $\ln k \to +\infty$'dur. Öte yandan $h(t) = (1+t)^p$ fonksiyonunun $t = 0$ noktasındaki türevi $h'(0) = p$ olduğundan, türev tanımı gereği
   ...
   olur. $t_k \to 0$ ve $t_k \ne 0$ olduğundan, fonksiyon limiti için dizisel ölçüt (@thm-dizisel-olcut) gereği $g(t_k) \to p$'dir.

(7\) ve limit aritmetiği (@thm-limit-aritmetigi) gereği
...
::: {.ispat}
**(a)** Önce $0 < L < 1$ olsun. $\dfrac{a_{k+1}}{a_k} \to L > 0$ olduğundan, limit aritmetiği (@thm-limit-aritmetigi) gereği
...
olur. $t_k = \dfrac{1}{k} \to 0$ ve $t_k \ne 0$ olduğundan, dizisel ölçüt (@thm-dizisel-olcut) gereği
...
Limit aritmetiği (@thm-limit-aritmetigi) gereği
