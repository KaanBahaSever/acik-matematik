...
::: {.callout-warning title="Yoğunluk fonksiyonundaki katsayı"}
Kaynak notta yoğunluk fonksiyonu $\dfrac{\lambda a\,(\lambda a)^{n-1} e^{-\lambda a}}{(n-1)!}$ olarak yazılmıştır; baştaki çarpan **$\lambda a$ değil $\lambda$** olmalıdır.

Doğrusu, kümülatif dağılımın türevi alınarak görülebilir:
...
Fazladan bir $a$ çarpanı olsaydı yoğunluğun integrali $1$ etmezdi.
:::
