...
<svg viewBox="22.0 6.0 356.0 254.5" role="img" aria-label="Kompleks duzlem, z = x + iy noktasi, 1 ve i noktalari">
  <g stroke="var(--academic-text)" stroke-width="1.1" opacity="0.5" fill="var(--academic-text)">
  <line x1="36.0" y1="191.3" x2="364.0" y2="191.3"/>
  <line x1="98.2" y1="246.2" x2="98.2" y2="20.0"/>
  <polygon points="364.0,191.3 356.0,187.8 356.0,194.8" stroke="none"/>
  <polygon points="98.2,20.0 94.7,28.0 101.7,28.0" stroke="none"/>
  </g>
  <g fill="var(--academic-text)" font-size="11" opacity="0.7">
  </g>
  <g fill="var(--academic-text)" font-size="11.5" font-style="italic" opacity="0.85">
  <text x="362.0" y="206.3" text-anchor="end">Re (reel eksen)</text>
  <text x="105.2" y="29.0">Im (sanal eksen)</text>
  </g>
  <path d="M243.6,191.3 L243.6,82.2" fill="none" stroke="var(--color-base)" stroke-width="1.3" stroke-dasharray="5 4" opacity="0.8" stroke-linejoin="round" stroke-linecap="round"/>
  <path d="M98.2,82.2 L243.6,82.2" fill="none" stroke="var(--color-base)" stroke-width="1.3" stroke-dasharray="5 4" opacity="0.8" stroke-linejoin="round" stroke-linecap="round"/>
  <circle cx="243.6" cy="82.2" r="4.2" fill="var(--color-theory)"/>
  <circle cx="170.9" cy="191.3" r="3.4" fill="var(--color-remark)"/>
  <circle cx="98.2" cy="118.5" r="3.4" fill="var(--color-remark)"/>
  <text x="252.6" y="76.2" fill="var(--color-theory)" font-size="12.5" text-anchor="start" font-weight="600">z = (x, y) = x + iy</text>
  <text x="243.6" y="207.3" fill="var(--academic-text)" font-size="12" text-anchor="middle" font-style="italic">x</text>
  <text x="90.2" y="86.2" fill="var(--academic-text)" font-size="12" text-anchor="end" font-style="italic">y</text>
  <text x="170.9" y="207.3" fill="var(--color-remark)" font-size="11" text-anchor="middle">1 = (1, 0)</text>
  <text x="90.2" y="122.5" fill="var(--color-remark)" font-size="11" text-anchor="end">i = (0, 1)</text>
  <text x="91.2" y="205.3" fill="var(--academic-text)" font-size="11" text-anchor="end">0</text>
</svg>
<figcaption>Kompleks d&#252;zlem: yatay eksen reel k&#305;sm&#305;, d&#252;&#351;ey eksen sanal k&#305;sm&#305; ta&#351;&#305;r. <em>z</em> = (<em>x</em>, <em>y</em>) s&#305;ral&#305; ikilisi d&#252;zlemin bir noktas&#305;d&#305;r; 1 = (1, 0) reel eksende, <em>i</em> = (0, 1) sanal eksende birim uzakl&#305;ktaki noktalard&#305;r.</figcaption>
</figure>
```
...
biçimindedir; ama bu formül ezberlenmez. Pratikte pay ve payda, paydanın sanal kısmının işareti değiştirilmiş kopyasıyla — yani $x_2 - iy_2$ ile — çarpılır; payda böylece reel sayı $x_2^2 + y_2^2$ olur. Bu işlem, [bir sonraki bölümde](vektorler-ve-modul.qmd) tanıtılacak eşlenik kavramının ilk görünüşüdür.
