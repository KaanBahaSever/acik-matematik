...
$$2\int_\rho^R \frac{\ln r}{\big(r^2+4\big)^2}\,dr + i\pi\int_\rho^R \frac{dr}{\big(r^2+4\big)^2} = \frac{\pi}{16}\big(\ln 2 - 1\big) + i\frac{\pi^2}{32} - \int_{C_\rho} f\,dz - \int_{C_R} f\,dz \tag{8}$$
...
*Yanıt:* a) $0$ — iki girintinin katkıları $-\pi i B_{-1}$ ve $-\pi i B_{1}$ birbirini götürür.
:::
