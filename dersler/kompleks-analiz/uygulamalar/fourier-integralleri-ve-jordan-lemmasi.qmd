...
Payın derecesi paydayı yalnızca bir eksilttiğinden yarım çemberin sönmesi için Jordan lemması gerekir; $e^{i2z}$ çarpanı sayesinde lemma uygulanabilir ve katkı sıfıra gider:
