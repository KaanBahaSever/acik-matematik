...
Kanıt, @thm-taylor-teklik ile aynı yolu izler; tek fark, terim terime integrasyon teoreminin negatif kuvvetleri de içeren serilere uygulanmasıdır (bu, $w = 1/(z - z_0)$ dönüşümüyle gerekçelendirilir) ve sonuçta

$$c_n = \frac{1}{2\pi i}\int_C \frac{f(z)\,dz}{(z - z_0)^{n+1}} \qquad (n = 0, \pm 1, \pm 2, \dots)$$

[Laurent teoremindeki](laurent-serileri.qmd) katsayı formülü elde edilir.
...
$$\frac{1}{1 + \dfrac{z^2}{3!} + \dfrac{z^4}{5!} + \cdots} = 1 - \frac{1}{3!}z^2 + \left[\frac{1}{(3!)^2} - \frac{1}{5!}\right]z^4 + \cdots = 1 - \frac{1}{6}z^2 + \frac{7}{360}z^4 + \cdots$$
...
*Yanıtlar:* a) $\displaystyle\sum_{n=0}^{\infty} (-1)^n (n+1)\,z^{2n+1}$; c) $\dfrac{1}{z^2} + \dfrac{1}{6} + \cdots$
:::
