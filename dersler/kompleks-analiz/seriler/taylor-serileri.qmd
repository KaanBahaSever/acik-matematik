...
::: {.ispat}
Önce $z_0 = 0$ durumunu, yani $(4)$ ifadesini kuralım.
...
$r/r_0 < 1$ olduğundan sağ taraf $N \to \infty$ iken sıfıra gider; $(4)$ kanıtlanmıştır.
...
*Yanıtlar:* a) $\displaystyle\sum_{n=0}^{\infty} \frac{(-1)^n}{3^{2n+2}}\,z^{4n+1}$, $|z| < \sqrt{3}$; b) $\displaystyle\sum_{n=0}^{\infty} \frac{(z - i)^n}{(1-i)^{n+1}}$, $|z - i| < \sqrt{2}$; c) $\displaystyle\sum_{n=0}^{\infty} \frac{(-1)^{n+1}}{(2n+1)!}\left(z - \frac{\pi}{2}\right)^{2n+1}$.
:::
