...
*Yanıtlar:* a) $1 + \dfrac{1}{z}$; b) $\displaystyle z^3\sin\frac{1}{z} = \sum_{n=0}^{\infty}\frac{(-1)^n}{(2n+1)!}\,z^{2-2n} = z^2 - \frac{1}{6} + \frac{1}{120}\cdot\frac{1}{z^2} - \cdots$ — üsler daima çifttir; c) sırasıyla $-\displaystyle\sum_{n=0}^{\infty}\frac{z^{n-1}}{2^{n+1}}$ ve $\displaystyle\sum_{n=2}^{\infty}\frac{2^{n-2}}{z^{n}}$.
:::
