...
Teorem, üç ifadeden herhangi birinin belirli bir $f$ için doğru olduğunu **iddia etmez**; yalnızca ya üçünün birden doğru ya üçünün birden yanlış olduğunu söyler. İspatı bölümün sonunda vereceğiz; önce teoremin nasıl kullanıldığını görelim.
...
@thm-ters-turev için (a) $\Rightarrow$ (b) $\Rightarrow$ (c) $\Rightarrow$ (a) zincirini kurmak yeterlidir.
...
*Yanıtlar:* a) $\dfrac{1 + i}{\pi}$; b) $e + \dfrac{1}{e}$; c) $0$.
:::
