...
Sonucun sıfır olmaması şaşırtıcı değildir: $\bar z$ analitik olmadığından Cauchy-Goursat teoremi burada uygulanamaz. (Birim çember üzerinde $\bar z = 1/z$ olduğuna dikkat ediniz; hesap aslında $\displaystyle\int_C \frac{dz}{z} = 2\pi i$ integralini vermiştir.)
