...
verilsin. $I_{n}$'i, temel fonksiyonlarla yazılmış bir terim ile daha küçük indisli bir ya da birkaç $I_{k}$ ($k < n$) cinsinden ifade eden bağıntıya bir **indirgeme formülü** (reduction formula) denir. Bir indirgeme formülü, ancak bir **taban durum** ($I_{0}$ ya da $I_{1}$) doğrudan hesaplanabiliyorsa aileyi tümüyle belirler: bu durumda tümevarımla (bkz. [Analiz 1](../analiz-1/dogal-sayilar-ve-tumevarim.html#thm-tumevarim-ilkesi)) her $n$ için $I_{n}$ elde edilir.
:::
