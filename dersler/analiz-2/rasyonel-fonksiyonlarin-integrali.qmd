...
::: {.ispat}
**Varlık.** $\deg Q = m$ olsun ve $\deg P$ üzerinden güçlü tümevarım yapalım (bkz. [Analiz 1](../analiz-1/dogal-sayilar-ve-tumevarim.html#thm-guclu-tumevarim)). $P = 0$ ya da $\deg P < m$ ise $S = 0$, $R = P$ almak yeter.
...
$$\begin{aligned}
\frac{1}{2a}\left(\frac{1}{x-a} - \frac{1}{x+a}\right) &= \frac{1}{2a}\cdot\frac{(x+a)-(x-a)}{(x-a)(x+a)} \\
&= \frac{1}{2a}\cdot\frac{2a}{x^2-a^2} = \frac{1}{x^2-a^2}
\end{aligned}$$
