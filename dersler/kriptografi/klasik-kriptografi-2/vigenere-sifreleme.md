...
::: tip Toplam Anahtar Uzayı ve Kasiski İncelemesi
...
::: details 🟢 Örnek 1: Açık metni "MATH" olan bir mesajı, K = "KEY" anahtarı kullanarak Vigenère şifrelemesi ile şifreleyiniz.
**Çözüm:**
...
Şimdi formüle ($e_K(x_i) \equiv x_i + k_i \pmod{26}$) göre her harfi alt alta toplayalım:

1. **M** (12) + **K** (10) = 22 $\implies$ **W**
2. **A** (0) + **E** (4) = 4 $\implies$ **E**
3. **T** (19) + **Y** (24) = 43 $\equiv$ 17 $\pmod{26} \implies$ **R**
4. **H** (7) + **K** (10) = 17 $\implies$ **R**

**Sonuç:** `MATH` kelimesi Vigenère ile `WERR` olarak şifrelenir. 
*(Dikkat Edin: Açık metinde hiç tekrar eden harf olmamasına rağmen, şifreli metinde iki tane yan yana 'R' harfi oluştu. İşte frekans analizini çökerten özellik budur!)*
:::

::: details 🔵 Örnek 2: K = "KEY" anahtarı ile şifrelenmiş olan "WERR" kapalı metnini deşifre ediniz.
**Çözüm:**
...
1. **W** (22) - **K** (10) = 12 $\implies$ **M**
2. **E** (4) - **E** (4) = 0 $\implies$ **A**
3. **R** (17) - **Y** (24) = -7 
   *Negatif sonucu pozitife çevirelim:* $-7 \equiv -7 + 26 = 19 \pmod{26} \implies$ **T**
4. **R** (17) - **K** (10) = 7 $\implies$ **H**
